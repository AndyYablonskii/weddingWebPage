    ...
    return (
        <div style={containerStyle}>
            ...
            <div className="history" style={historyTextStyle}>
                ...
                <div>
                    <b>2021 р.</b> вони знову зустрілися. Знову в таборі. Проте вже в ролі лідерів. Дружили в компанії, навіть не уявляючи, <br /> що Бог запланував створити з цієї дружби щось набагато більше…<br />
                </div>
                <div>
                    <b>2022 р.</b> війна. Вона поїхала за кордон.  Вони не спілкувалися, проте при згадці старої дружби <br /> в серці щось тихенько й ніжно йокало. Без думки один про одного вона молилася про духовного чоловіка, <br /> який грає на гітарі. А він — про дружину-служительку, яка знає англійську.
                    <br /> P.s. так і вийшло<br />
                </div>
                <div>
                ...
                <div>
                    <b>07.03.25</b> нарешті вона сказала йому найвпевненіше «так», <br /> та усвідомила: він подарував їй казку, <br /> про яку вона навіть не мріяла.
                </div>
